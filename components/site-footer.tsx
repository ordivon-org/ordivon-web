    ...
    <footer className="site-footer">
      <div className="site-footer-inner">
        ...
        <div className="footer-links">
          <div><span>Explore</span><Link href="/system">System</Link><Link href="/research">Research</Link><Link href="/projects">Projects</Link><Link href="/writing">Writing</Link><Link href="/now">Now</Link></div>
