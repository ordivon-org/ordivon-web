...
export type ArticleMetadata = {
  ...
  takeaways: readonly [string, string, string, ...string[]];
...
export const articleMetadata = [
  {
    ...
    "date": "2026-07-31", "modifiedDate": "2026-08-01", "readMinutes": 12, "author": "zycxfyh",
    ...
    "evidenceLevel": "E3",
    "takeaways": ["A model call is only one layer in a complete work system.", "Harness, Host, Runtime, and World fail differently and should not share one authority.", "Durable progress is a graph of admitted work and evidence, not a long conversation."],
    "limitations": ["The architecture combines public provider behavior with Ordivon experiments; it does not establish every provider's private implementation.", "World remains less experimentally mature than Host and Runtime."],
  ...
  },
  {
    ...
    "date": "2026-07-31", "modifiedDate": "2026-08-01", "readMinutes": 10, "author": "zycxfyh",
    ...
    "evidenceLevel": "E4",
    "takeaways": ["Mature provider harnesses should remain native rather than be flattened into one lifecycle.", "A thin first-party harness is still needed for bare model APIs and controlled loop research.", "The v0 boundary is admitted by a deletion condition, not by a universal-platform ambition."],
    "limitations": ["The decision is grounded in Codex and Hermes plus current bare-API requirements, not every future provider.", "The first-party harness has not yet earned a separate repository through broad production use."],
  ...
  },
  {
    ...
    "evidenceLevel": "E4",
    "takeaways": ["One Host task remained coherent through both tested Codex↔Hermes replacement orders.", "Stale completion, missing artifacts, and response loss did not become accepted task truth.", "Provider sessions and lifecycles remained materially different; replacement did not require equivalence."],
    "limitations": ["The experiment used one bounded repository task and two provider harnesses.", "It did not establish general provider interchangeability, model quality, or long-horizon autonomy."],
  ...
  },
  {
    ...
    "claimClass": "thesis",
    "evidenceLevel": "E1",
    "takeaways": ["Durable systems should preserve the work of finite participants without freezing their implementations.", "Cheap generation raises the burden of permanent governance and broad restrictions.", "Thin cores and recoverable experiments let judgment remain active where formal criteria are incomplete."],
    "limitations": ["This is a normative and architectural thesis, not an experimental proof of broad social outcomes.", "Its practical value depends on continued evidence from Ordivon workloads and external alternatives."],
  ...
  },
  {
    ...
    "evidenceLevel": "E4",
    "takeaways": ["Station Zero became source-playable as an exact alpha release.", "Replay, diagnosis, comparison, and reload recovery are part of the release journey rather than screenshots.", "The release proves a bounded playable loop, not a general agent-game platform."],
    "limitations": ["The alpha contains one bounded mission and developer-oriented operation.", "External player usability, broader mechanics, and sustained agent behavior remain unproven."],
  ...
  },
  {
    ...
    "claimClass": "experimental-result",
    "evidenceLevel": "E4",
    "takeaways": ["Explicit goal dependencies and consequence visibility improved two live paths without adding a hidden planner.", "The model retained the final choice; Host compiled trustworthy decision semantics rather than rank one.", "More transcript history was not the missing capability."],
    "limitations": ["The comparison covers one game workload and two live paths.", "It does not prove that the same semantic compilation improves arbitrary strategic tasks."],
  ...
  },
  {
    ...
    "claimClass": "engineering-inference",
    "evidenceLevel": "E4",
    "takeaways": ["A working sidecar still lost when it duplicated semantic authority.", "Embedding the authority preserved exact World outcomes while deleting thirteen truth tables.", "Contract reuse does not require every workload to share one process."],
    "limitations": ["The conclusion applies to this Host/Game boundary and does not reject sidecars generally.", "The latency and deletion gains were measured in one local architecture."],
  ...
  },
  {
    ...
    "claimClass": "engineering-inference",
    "evidenceLevel": "E4",
    "takeaways": ["Replay and diagnosis can be deterministic projections of retained authority.", "Point-in-time state, evidence graphs, and comparisons do not require another mutable database.", "Disposable projections improve recovery because they can be rebuilt from source evidence."],
    "limitations": ["Projection cost may require caching at larger scale.", "The approach assumes the authoritative records preserve enough identity and evidence."],
  ...
  },
  {
    ...
    "claimClass": "engineering-inference",
    "evidenceLevel": "E2",
    "takeaways": ["A transcript can preserve rationale while omitting operation identity and unresolved commitment.", "More historical text can amplify stale or untrusted instructions.", "Conversation history is cognitive evidence, not authoritative task state."],
    "limitations": ["The note synthesizes bounded Ordivon failures rather than a controlled cross-system benchmark.", "Some short-lived tasks can safely rely on transcripts because their consequences are cheap and local."],
  ...
  },
  {
    ...
    "claimClass": "architecture-decision",
    "evidenceLevel": "E2",
    "takeaways": ["No response does not establish that no external effect occurred.", "UNKNOWN must remain bound to operation identity, correlation, reconciliation, and a no-blind-redispatch rule.", "Waiting or reconciling can be the correct action."],
    "limitations": ["The note defines a boundary but does not benchmark reconciliation across many providers.", "Some external systems cannot expose enough correlation to resolve uncertainty automatically."],
  ...
  },
  {
    ...
    "claimClass": "experimental-result",
    "evidenceLevel": "E3",
    "takeaways": ["The same task offer produced different outcomes when reachability changed.", "Messages need identity, delivery state, and World-conditioned timing rather than decorative logs.", "Delayed communication can consume an irreversible coordination window."],
    "limitations": ["The result comes from one bounded Station Zero comparison.", "It does not establish multi-agent superiority or a universal communication protocol."],
  ...
  },
  {
    ...
    "claimClass": "experimental-result",
    "evidenceLevel": "E3",
    "takeaways": ["Action success, reward, spread, interpretation, and objective completion repeatedly disagreed.", "Better belief can still spend the option to act before the horizon closes.", "The multidimensional method survived; a strategic agent ontology did not earn promotion."],
    "limitations": ["The 84 trials were bounded local and benchmark experiments, not an open-ended campaign.", "Model-backed diagnostics did not demonstrate an agent that defeated an adaptive opponent."],
  ...
  },
  {
    ...
    "claimClass": "experimental-result",
    "evidenceLevel": "E4",
    "takeaways": ["Strong workflow, retrieval, idempotency, and provider baselines made the proposed Ordivon core smaller.", "Task Runtime and generalized Context Kernel did not survive; Effect and DecisionRequest narrowed.", "Provider-neutral task state remained independently necessary under live replacement."],
    "limitations": ["Round 1 used a frozen workload designed to isolate four causal questions.", "Retained boundaries still need pressure from broader repository goals and external-world recovery."],
  ...
  },
  {
    ...
    "claimClass": "thesis",
    "evidenceLevel": "E1",
    "takeaways": ["AI acceleration should be paired with verification, resilience, access, and institutional adaptation.", "Historical constraints should not be treated as timeless reasons to freeze a new production frontier.", "The practical response is to build capability and complementary systems faster, not center civilization on slowdown."],
    "limitations": ["The essay is a civilizational argument, not a forecast with calibrated probabilities.", "Its policy implications depend on contested values and uncertain future distributions of capability."],
  ...
  },
  {
    ...
    "claimClass": "architecture-decision",
    "evidenceLevel": "E2",
    "takeaways": ["Connectivity and external execution are useful classical distinctions but poor top-level agent project boundaries.", "One recoverable external action needs path, identity, authority, effect, observation, and reconciliation together.", "Link and Edge were retired into the narrower World research boundary."],
    "limitations": ["World is still an experimental boundary and has not yet won against direct Host integration in W1.", "The unification does not replace mature transport or provider-native mechanisms."],
    "canonicalResearchRecord": "https://github.com/zycxfyh/ordivon-world",
    "toc": [
      {
  ...
  },
  {
    ...
    "claimClass": "engineering-inference",
    "evidenceLevel": "E4",
    "takeaways": ["Sustained use expanded Runtime from ten tools to a closed execution and recovery lifecycle.", "Commitment identity, structured progress, retention, repair, and status improved operation without absorbing task meaning.", "The core remained thin by deleting an overlapping editor and rejecting workflow ownership."],
    "limitations": ["Production-tested means sustained local use, not external production replication.", "Future workloads may expose operational gaps without changing Runtime's semantic boundary."],
  ...
  },
  {
    ...
    "claimClass": "architecture-decision",
    "evidenceLevel": "E4",
    "takeaways": ["Runtime can recover a process but should not decide what the user meant or whether evidence satisfies a task.", "Host owns semantic continuity above replaceable sessions and process execution.", "Deterministic reads, bounded cognition, guarded mutation, and recovery established an independent state owner."],
    "limitations": ["The boundary was established through Ordivon repository and game workloads, not every class of agent work.", "Host still depends on workload-specific verification and does not make model decisions universally correct."],
  ...
  },
  {
    ...
    "claimClass": "observed-fact",
    "evidenceLevel": "E4",
    "takeaways": ["The M0–M7 release closed a ten-tool local execution and recovery core.", "Direct production MCP use validated isolated workspaces, durable jobs, observation, cancellation, artifacts, and restart recovery.", "Later Runtime work extends this historical release without rewriting what shipped."],
    "limitations": ["The release predates later commitment, progress, repair, and lifecycle additions.", "Production-tested locally is not a claim of external production readiness."],
  ...
  },
  {
    ...
    "claimClass": "thesis",
    "evidenceLevel": "E1",
    "takeaways": ["Capable models do not by themselves preserve task meaning, execution evidence, or responsibility.", "Real work crosses repositories, processes, credentials, machines, and consequential decisions.", "Ordivon exists to make those trajectories durable while keeping intelligence replaceable."],
    "limitations": ["The argument establishes a design problem, not that Ordivon is the only or final solution.", "Several mature systems already carry parts of the responsibility and should remain strong baselines."],
