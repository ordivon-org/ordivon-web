...
export const articleMetadata = [
  ...
  },
  {
    ...
    "deck": "Why Ordivon builds durable continuity around finite participants, keeps the permanent core thin, lets reversible exploration remain wide, and concentrates strictness at consequential boundaries.",
  ...
  },
  {
    ...
    "title": "Station Zero v0.1.0-alpha.1",
    "kicker": "Release note / Agent-native game",
    "deck": "The first source-playable developer Alpha binds one mission, exact replay, evidence-linked diagnosis, immutable deployment, same-Case comparison, reload recovery, and clean archive reverification to one release identity.",
