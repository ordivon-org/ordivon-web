...
export const projects: ProjectDefinition[] = [
  {
    ...
    state: "Core Work System Round 1 reduced the proposed shared core against LangGraph, Temporal, direct retrieval, durable Activities, and live Codex/Hermes replacement; Harness Stage 1 H1–H5 is now complete in Host.",
  ...
  },
  {
    ...
    state: "Harness Stage 1 H1–H5 is complete: Host owns Assignment fencing and completion adjudication, retains provider-faithful Codex App Server and Hermes ACP lifecycles, completed both live replacement orders, recovered one lost repair response without redispatch, and rejected stale or evidence-incomplete completion claims.",
    evidence: [{ value: "H1–H5", label: "Stage 1 complete" }, { value: "4", label: "live Provider Runs in H5" }, { value: "0", label: "shared lifecycle adapters promoted" }],
...
export const questions: QuestionDefinition[] = [
  ...
  },
  {
    ...
    currentJudgment: "Answered within Harness Stage 1. H1–H5 retained immutable Task Attempt, Assignment generation, HarnessRunReceipt, CompletionProposal/Decision, opaque Runtime references, and provider-specific direct drivers. Both replacement orders completed accepted repository repairs; stale generation, missing Artifact, and dropped-response faults were handled. A shared lifecycle adapter, common Session, event runtime, new SQL tables, Runtime Task state, and a separate Harness repository were rejected.",
    nextStep: "Use the retained objects in broader repository work and reopen the boundary only if a third provider or materially different workload exposes repeated lifecycle logic that direct drivers cannot own economically.",
